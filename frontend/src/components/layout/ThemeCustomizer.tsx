...
export type ThemeCustomizerScope = 'admin' | 'site'

type ThemeCustomizerBaseProps = {
  scope: ThemeCustomizerScope
  setOpen?: (open: boolean) => void
}

const ThemeCustomizerBase = ({ scope, setOpen }: ThemeCustomizerBaseProps) => {
...
const AdminThemeCustomizer = () => {
  ...
  return <ThemeCustomizerBase scope='admin' setOpen={setOpen} />
}
...
const ThemeCustomizer = ({ scope = 'admin' }: ThemeCustomizerProps) => {
  if (scope === 'site') return <ThemeCustomizerBase scope='site' />

  return <AdminThemeCustomizer />
}
