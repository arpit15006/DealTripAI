...
const countries = [
  {
    value: 'india',
    label: 'India',
    flag: '/images/countries/flags/india.webp'
  },
  {
    value: 'china',
    label: 'China',
    flag: '/images/countries/flags/china.webp'
  },
  {
    value: 'monaco',
    label: 'Monaco',
    flag: '/images/countries/flags/monaco.webp'
  },
  {
    value: 'serbia',
    label: 'Serbia',
    flag: '/images/countries/flags/serbia.webp'
  },
  {
    value: 'romania',
    label: 'Romania',
    flag: '/images/countries/flags/romania.webp'
  },
  {
    value: 'mayotte',
    label: 'Mayotte',
    flag: '/images/countries/flags/mayotte.webp'
  },
  {
    value: 'iraq',
    label: 'Iraq',
    flag: '/images/countries/flags/iraq.webp'
  },
  {
    value: 'syria',
    label: 'Syria',
    flag: '/images/countries/flags/syria.webp'
  },
  {
    value: 'korea',
    label: 'Korea',
    flag: '/images/countries/flags/korea.webp'
  },
  {
    value: 'zimbabwe',
    label: 'Zimbabwe',
    flag: '/images/countries/flags/zimbabwe.webp'
  }
]
